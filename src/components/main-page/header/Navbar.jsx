  ...
  return (
    <>
      <div className="navLinks">
        ...
        >
          ...
          <div
            ...
            style={{
              width:
                activeSection === 'services'
                  ? `${160 * sections.services.length}px`
                  : '0px',
            }}
            id="side"
          >
        ...
        <div
          className={
            activeSection === 'about' ? 'slidingAbout hovered' : 'slidingAbout'
          }
        ...
        >
          <div>About Us</div>
          <div
            className={activeSection === 'about' ? 'menu show' : 'menu hidden'}
            style={{
              width:
                activeSection === 'about'
                  ? `${120 * sections.about.length}px`
                  : '0px',
            }}
            id="side"
          >
