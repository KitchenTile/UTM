...
const Ourservices = () => {
    ...
    const buttonTitles = ["Tech Club", "Breakfast Club", "After School Care", "Tech Camp"];
        ...
        <div className="servicesContainer">
            ...
            <div className="textPicContainer">
                <div className="mainText">
                    ...
                    <p>At U Teach Mi, our services have garnered rave reviews from students and parents alike. Experience the enthusiasm firsthand as families praise our engaging and educational programs, where young minds thrive in a creative tech environment. </p>
                </div>
                <div className="picturesContainer">
                {servicePictures.map((picture, index) => (
                    <div className="pictureButton">
                        <img src={picture} key={index} id={`ServicePic${index}`} alt={`Service ${index}`} />
                        <button /*onClick={}*/ title={buttonTitles[index]} key={index} id={`Button${index}`}>{buttonTitles[index]}</button>
                    </div>
                ))}
                </div>
            </div>
